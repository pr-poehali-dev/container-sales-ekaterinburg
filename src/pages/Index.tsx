...
const containers = [
  ...
  },
  {
    ...
    size: "40' HC",
    dimensions: "12.2 × 2.4 × 2.9 м",
    volume: "76 м³",
    price: "от 165 000 ₽",
    desc: "High Cube — повышенная высота для объёмных негабаритных грузов.",
    img: "https://cdn.poehali.dev/projects/612813ef-1a83-4228-928a-b7c408a798c0/files/14f422f4-ba35-4ab5-86ca-80577266e54e.jpg",
  },
];
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[#555] leading-relaxed mb-6">
                КонтейнерПро — ведущий поставщик морских контейнеров в Екатеринбурге. Мы работаем с промышленными предприятиями, строительными компаниями и частными покупателями.
              </p>
